...
@IF EXIST "%MSRKINECTSDK%\lib" (SET KINECTSDK_VERSION=Beta1)
@IF EXIST "%KINECTSDK_DIR%\lib" (SET KINECTSDK_VERSION=Beta2)
@IF EXIST "%KINECTSDK10_DIR%\lib" (SET KINECTSDK_VERSION=V10)
